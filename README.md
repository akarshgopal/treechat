...
7. Branches and view mode persist in `localStorage` (`treechat:v2`). The OpenRouter key is stored separately (`treechat:provider:v1`). Use the header reset control to restore the seeded demo (it does not clear the key).
